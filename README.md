## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,634 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,547 | 🐛 39,260 | 🌐 LLVM | 📅 2026-09-19
* :octocat: [LLVM-Tutor](https://github.com/banach-space/llvm-tutor) ⭐ 3,434 | 🐛 14 | 🌐 C++ | 📅 2026-05-17 - A collection of out-of-tree LLVM passes for teaching and learning
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,547 | 🐛 39,260 | 🌐 LLVM | 📅 2026-09-19 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,919 | 🐛 586 | 🌐 C++ | 📅 2026-09-18 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,359 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 624 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-09-18 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,616 | 🐛 2,483 | 🌐 C++ | 📅 2026-09-18 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,706 | 🐛 206 | 🌐 OCaml | 📅 2026-09-18 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,631 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,960 | 🐛 129 | 🌐 C | 📅 2026-09-08 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,239 | 🐛 1,155 | 🌐 C++ | 📅 2026-09-18 - Circuit IR Compilers and Tools
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,296 | 🐛 167 | 🌐 Python | 📅 2026-09-18 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,837 | 🐛 116 | 🌐 Python | 📅 2026-09-18
* [numba](https://github.com/numba/numba) ⭐ 11,156 | 🐛 1,792 | 🌐 Python | 📅 2026-09-18
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,789 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
