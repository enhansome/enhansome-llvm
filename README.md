## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,150 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,619 | 🐛 39,402 | 🌐 LLVM | 📅 2026-09-23
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,619 | 🐛 39,402 | 🌐 LLVM | 📅 2026-09-23 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,920 | 🐛 589 | 🌐 C++ | 📅 2026-09-22 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  ...
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 85 | 🌐 MLIR | 📅 2026-09-22 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,626 | 🐛 2,489 | 🌐 C++ | 📅 2026-09-22 - An LLVM-to-JavaScript Compiler
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,966 | 🐛 129 | 🌐 C | 📅 2026-09-22 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,240 | 🐛 1,159 | 🌐 C++ | 📅 2026-09-22 - Circuit IR Compilers and Tools
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,836 | 🐛 74 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,820 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 - A Dynamic Binary Instrumentation framework based on LLVM
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,709 | 🐛 211 | 🌐 C++ | 📅 2026-09-21 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,058 | 🐛 38 | 🌐 C++ | 📅 2026-09-08 - A LLVM-based static analysis framework
...
* [seahorn/clam](https://github.com/seahorn/clam) ⭐ 289 | 🐛 5 | 🌐 C | 📅 2026-09-12 - a static analyzer (CLI) based on [seahorn/crab](https://github.com/seahorn/crab) ⭐ 255 | 🐛 4 | 🌐 C++ | 📅 2026-09-23, the latter of which is abstract Interpretation-based library
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,297 | 🐛 166 | 🌐 Python | 📅 2026-09-22 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,836 | 🐛 119 | 🌐 Python | 📅 2026-09-23
* [numba](https://github.com/numba/numba) ⭐ 11,158 | 🐛 1,800 | 🌐 Python | 📅 2026-09-21
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,693 | 🐛 404 | 🌐 Scala | 📅 2026-09-15
* [solang](https://github.com/hyperledger/solang) ⭐ 1,383 | 🐛 294 | 🌐 Rust | 📅 2026-09-08
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,370 | 🐛 584 | 🌐 D | 📅 2026-09-23
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,798 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
...
* :octocat: [awesome-llvm-security](https://github.com/gmh5225/awesome-llvm-security) ⭐ 880 | 🐛 0 | 📅 2026-09-22 - awesome llvm security projects
