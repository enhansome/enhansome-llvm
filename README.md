## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,875 | 🐛 103 | 📅 2026-08-18
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 39,828 | 🐛 38,365 | 🌐 LLVM | 📅 2026-08-20
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 39,828 | 🐛 38,365 | 🌐 LLVM | 📅 2026-08-20 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,887 | 🐛 578 | 🌐 C++ | 📅 2026-08-19 - first class support from the PyTorch ecosystem to the MLIR ecosystem
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,574 | 🐛 2,465 | 🌐 C++ | 📅 2026-08-20 - An LLVM-to-JavaScript Compiler
...
* [circt](https://github.com/llvm/circt) ⭐ 2,221 | 🐛 1,146 | 🌐 C++ | 📅 2026-08-20 - Circuit IR Compilers and Tools
...
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,053 | 🐛 37 | 🌐 C++ | 📅 2026-08-19 - A LLVM-based static analysis framework
...
* [seahorn/clam](https://github.com/seahorn/clam) ⭐ 286 | 🐛 4 | 🌐 C | 📅 2026-08-08 - a static analyzer (CLI) based on [seahorn/crab](https://github.com/seahorn/crab) ⭐ 253 | 🐛 5 | 🌐 C++ | 📅 2026-08-16, the latter of which is abstract Interpretation-based library
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,283 | 🐛 173 | 🌐 Python | 📅 2026-08-18 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,828 | 🐛 119 | 🌐 Python | 📅 2026-08-19
* [numba](https://github.com/numba/numba) ⭐ 11,124 | 🐛 1,797 | 🌐 Python | 📅 2026-08-19
...
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,364 | 🐛 581 | 🌐 D | 📅 2026-08-20
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,736 | 🐛 28 | 🌐 Rust | 📅 2026-06-10 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
