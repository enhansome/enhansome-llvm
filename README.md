## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,512 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,489 | 🐛 39,158 | 🌐 LLVM | 📅 2026-09-16
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,489 | 🐛 39,158 | 🌐 LLVM | 📅 2026-09-16 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,916 | 🐛 585 | 🌐 C++ | 📅 2026-09-15 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,357 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 624 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-09-14 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,611 | 🐛 2,487 | 🌐 C++ | 📅 2026-09-16 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 208 | 🌐 OCaml | 📅 2026-09-10 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,630 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
...
* [klee](https://github.com/klee/klee) ⭐ 2,977 | 🐛 82 | 🌐 C++ | 📅 2026-08-21 - Symbolic Virtual Machine
...
* [circt](https://github.com/llvm/circt) ⭐ 2,240 | 🐛 1,149 | 🌐 C++ | 📅 2026-09-15 - Circuit IR Compilers and Tools
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,829 | 🐛 73 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,820 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 - A Dynamic Binary Instrumentation framework based on LLVM
...
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,057 | 🐛 35 | 🌐 C++ | 📅 2026-09-08 - A LLVM-based static analysis framework
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,295 | 🐛 167 | 🌐 Python | 📅 2026-09-16 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,838 | 🐛 115 | 🌐 Python | 📅 2026-09-16
* [numba](https://github.com/numba/numba) ⭐ 11,155 | 🐛 1,797 | 🌐 Python | 📅 2026-09-15
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,693 | 🐛 393 | 🌐 Scala | 📅 2026-09-15
* [solang](https://github.com/hyperledger/solang) ⭐ 1,382 | 🐛 293 | 🌐 Rust | 📅 2026-09-08
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,371 | 🐛 584 | 🌐 D | 📅 2026-09-16
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,782 | 🐛 13 | 🌐 Rust | 📅 2026-09-14 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
