## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,024 | 🐛 106 | 📅 2026-08-21
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 39,872 | 🐛 38,391 | 🌐 LLVM | 📅 2026-08-23
* :octocat: [LLVM-Tutor](https://github.com/banach-space/llvm-tutor) ⭐ 3,421 | 🐛 14 | 🌐 C++ | 📅 2026-05-17 - A collection of out-of-tree LLVM passes for teaching and learning
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 39,872 | 🐛 38,391 | 🌐 LLVM | 📅 2026-08-23 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  ...
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-08-23 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,576 | 🐛 2,477 | 🌐 C++ | 📅 2026-08-22 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,685 | 🐛 297 | 🌐 OCaml | 📅 2026-08-21 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
...
* [cling](https://github.com/root-project/cling) ⭐ 4,180 | 🐛 138 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,808 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,929 | 🐛 128 | 🌐 C | 📅 2026-08-19 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,226 | 🐛 1,129 | 🌐 C++ | 📅 2026-08-22 - Circuit IR Compilers and Tools
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,813 | 🐛 19 | 🌐 C++ | 📅 2026-08-21 - A Dynamic Binary Instrumentation framework based on LLVM
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,800 | 🐛 75 | 🌐 C++ | 📅 2026-07-01 - Library for lifting machine code to LLVM bitcode
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,703 | 🐛 210 | 🌐 C++ | 📅 2026-07-30 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,831 | 🐛 119 | 🌐 Python | 📅 2026-08-22
* [numba](https://github.com/numba/numba) ⭐ 11,125 | 🐛 1,795 | 🌐 Python | 📅 2026-08-21
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,685 | 🐛 420 | 🌐 Scala | 📅 2026-08-17
* [solang](https://github.com/hyperledger/solang) ⭐ 1,381 | 🐛 300 | 🌐 Rust | 📅 2026-08-15
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,364 | 🐛 580 | 🌐 D | 📅 2026-08-23
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,745 | 🐛 27 | 🌐 Rust | 📅 2026-06-10 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
...
* :octocat: [awesome-llvm-security](https://github.com/gmh5225/awesome-llvm-security) ⭐ 874 | 🐛 0 | 📅 2026-08-14 - awesome llvm security projects
