## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,837 | 🐛 100 | 📅 2026-06-30
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 39,803 | 🐛 38,215 | 🌐 LLVM | 📅 2026-08-15
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 39,803 | 🐛 38,215 | 🌐 LLVM | 📅 2026-08-15 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,886 | 🐛 580 | 🌐 C++ | 📅 2026-08-15 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,344 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,569 | 🐛 2,462 | 🌐 C++ | 📅 2026-08-14 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,674 | 🐛 298 | 🌐 OCaml | 📅 2026-08-12 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,607 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
* [ollvm](https://github.com/obfuscator-llvm/obfuscator/wiki) ⭐ 4,382 | 🐛 97 | 📅 2023-10-20 - code obfuscation based on LLVM4.0
* [cling](https://github.com/root-project/cling) ⭐ 4,174 | 🐛 136 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,808 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,921 | 🐛 129 | 🌐 C | 📅 2026-08-12 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,219 | 🐛 1,141 | 🌐 C++ | 📅 2026-08-15 - Circuit IR Compilers and Tools
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,806 | 🐛 19 | 🌐 C++ | 📅 2026-07-24 - A Dynamic Binary Instrumentation framework based on LLVM
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,796 | 🐛 73 | 🌐 C++ | 📅 2026-07-01 - Library for lifting machine code to LLVM bitcode
...
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,053 | 🐛 39 | 🌐 C++ | 📅 2026-08-14 - A LLVM-based static analysis framework
...
* [smack](https://github.com/smackers/smack) ⭐ 448 | 🐛 97 | 🌐 C | 📅 2026-08-09 - SMACK Software Verifier and Verification Toolchain
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,281 | 🐛 171 | 🌐 Python | 📅 2026-08-14 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [numba](https://github.com/numba/numba) ⭐ 11,120 | 🐛 1,803 | 🌐 Python | 📅 2026-08-15
...
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,362 | 🐛 581 | 🌐 D | 📅 2026-08-15
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,735 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
...
* :octocat: [awesome-llvm-security](https://github.com/gmh5225/awesome-llvm-security) ⭐ 871 | 🐛 0 | 📅 2026-08-14 - awesome llvm security projects
