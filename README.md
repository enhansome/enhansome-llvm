## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,601 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,635 | 🐛 39,505 | 🌐 LLVM | 📅 2026-09-24
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,635 | 🐛 39,505 | 🌐 LLVM | 📅 2026-09-24 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,920 | 🐛 592 | 🌐 C++ | 📅 2026-09-23 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,360 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 625 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 86 | 🌐 MLIR | 📅 2026-09-23 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,628 | 🐛 2,491 | 🌐 C++ | 📅 2026-09-24 - An LLVM-to-JavaScript Compiler
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,967 | 🐛 129 | 🌐 C | 📅 2026-09-22 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,241 | 🐛 1,164 | 🌐 C++ | 📅 2026-09-24 - Circuit IR Compilers and Tools
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,838 | 🐛 74 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,820 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 - A Dynamic Binary Instrumentation framework based on LLVM
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,710 | 🐛 211 | 🌐 C++ | 📅 2026-09-24 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,058 | 🐛 36 | 🌐 C++ | 📅 2026-09-23 - A LLVM-based static analysis framework
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,297 | 🐛 164 | 🌐 Python | 📅 2026-09-23 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,836 | 🐛 119 | 🌐 Python | 📅 2026-09-24
* [numba](https://github.com/numba/numba) ⭐ 11,158 | 🐛 1,801 | 🌐 Python | 📅 2026-09-21
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,693 | 🐛 398 | 🌐 Scala | 📅 2026-09-23
* [solang](https://github.com/hyperledger/solang) ⭐ 1,383 | 🐛 294 | 🌐 Rust | 📅 2026-09-08
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,370 | 🐛 584 | 🌐 D | 📅 2026-09-24
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,803 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
