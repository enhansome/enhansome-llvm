## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,913 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,513 | 🐛 39,178 | 🌐 LLVM | 📅 2026-09-17
* :octocat: [LLVM-Tutor](https://github.com/banach-space/llvm-tutor) ⭐ 3,432 | 🐛 14 | 🌐 C++ | 📅 2026-05-17 - A collection of out-of-tree LLVM passes for teaching and learning
...
* 🐉 [LLVM Tutorials](http://llvm.org/docs/tutorial/index.html) - a list of tutorials
  * :octocat: [Python Version of the LLVM Tutorial](https://github.com/eliben/pykaleidoscope) ⭐ 345 | 🐛 1 | 🌐 Python | 📅 2026-07-01
* 🐉 [LLVM Language Reference Manual](http://llvm.org/docs/LangRef.html) - detailed docs for LLVM IR/Bitcode
  * :octocat: [PSA: Instruction-constructors changing to iterator-only insertion](https://github.com/sunxfancy/vscode-llvm) ⭐ 236 | 🐛 1 | 🌐 TypeScript | 📅 2024-05-30 - VSCode LLVM Compiler Explorer
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,513 | 🐛 39,178 | 🌐 LLVM | 📅 2026-09-17 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,918 | 🐛 585 | 🌐 C++ | 📅 2026-09-16 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,358 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 624 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 85 | 🌐 MLIR | 📅 2026-09-16 - Intel® Extension for MLIR
  * :octocat: [Lewuathe/mlir-hello](https://github.com/Lewuathe/mlir-hello) ⭐ 139 | 🐛 1 | 🌐 C++ | 📅 2025-12-23 - minimal Hello-World example of MLIR
  * out-of-tree MLIR project templates: [zincnode/mlir-he](https://github.com/zincnode/mlir-he) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2025-02-16, [jmgorius/mlir-standalone-template](https://github.com/jmgorius/mlir-standalone-template) ⭐ 120 | 🐛 3 | 🌐 CMake | 📅 2026-03-26, [Lewuathe/mlir-hello](https://github.com/Lewuathe/mlir-hello) ⭐ 139 | 🐛 1 | 🌐 C++ | 📅 2025-12-23
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,612 | 🐛 2,482 | 🌐 C++ | 📅 2026-09-17 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,704 | 🐛 207 | 🌐 OCaml | 📅 2026-09-16 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,629 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
* [ollvm](https://github.com/obfuscator-llvm/obfuscator/wiki) ⭐ 4,394 | 🐛 97 | 📅 2023-10-20 - code obfuscation based on LLVM4.0
* [cling](https://github.com/root-project/cling) ⭐ 4,192 | 🐛 138 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,809 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [klee](https://github.com/klee/klee) ⭐ 2,978 | 🐛 82 | 🌐 C++ | 📅 2026-08-21 - Symbolic Virtual Machine
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,958 | 🐛 129 | 🌐 C | 📅 2026-09-08 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,240 | 🐛 1,157 | 🌐 C++ | 📅 2026-09-17 - Circuit IR Compilers and Tools
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,831 | 🐛 74 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,818 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 - A Dynamic Binary Instrumentation framework based on LLVM
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,708 | 🐛 210 | 🌐 C++ | 📅 2026-09-16 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,056 | 🐛 35 | 🌐 C++ | 📅 2026-09-08 - A LLVM-based static analysis framework
* [microsoft/llvm-mctoll](https://github.com/microsoft/llvm-mctoll) ⭐ 880 | 🐛 46 | 🌐 C++ | 📅 2024-06-22 - statically (AOT) translates (or raises) binaries to LLVM IR
* [whole-program-llvm](https://github.com/travitch/whole-program-llvm) ⭐ 733 | 🐛 8 | 🌐 Python | 📅 2025-12-30 - A wrapper script to build whole-program LLVM bitcode files; its go port [gllvm](https://github.com/SRI-CSL/gllvm) ⭐ 342 | 🐛 13 | 🌐 Go | 📅 2024-04-28
* [llvm-pass-skeleton](https://github.com/sampsyo/llvm-pass-skeleton) ⭐ 612 | 🐛 8 | 🌐 C++ | 📅 2025-03-06 - example LLVM pass
* [DG](https://github.com/mchalupa/dg) ⭐ 524 | 🐛 93 | 🌐 C++ | 📅 2025-05-21 -  Various program analyses, construction of dependence graphs and program slicing of LLVM bitcode
  * dg can integrate SVF, see [here](https://github.com/mchalupa/dg/blob/master/doc/SVF.md) ⭐ 524 | 🐛 93 | 🌐 C++ | 📅 2025-05-21 for details
* [smack](https://github.com/smackers/smack) ⭐ 448 | 🐛 95 | 🌐 C | 📅 2026-08-28 - SMACK Software Verifier and Verification Toolchain
...
* [seahorn/clam](https://github.com/seahorn/clam) ⭐ 289 | 🐛 5 | 🌐 C | 📅 2026-09-12 - a static analyzer (CLI) based on [seahorn/crab](https://github.com/seahorn/crab) ⭐ 254 | 🐛 4 | 🌐 C++ | 📅 2026-09-12, the latter of which is abstract Interpretation-based library
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,296 | 🐛 167 | 🌐 Python | 📅 2026-09-16 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,837 | 🐛 115 | 🌐 Python | 📅 2026-09-16
* [numba](https://github.com/numba/numba) ⭐ 11,154 | 🐛 1,793 | 🌐 Python | 📅 2026-09-16
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,693 | 🐛 394 | 🌐 Scala | 📅 2026-09-15
* [solang](https://github.com/hyperledger/solang) ⭐ 1,382 | 🐛 293 | 🌐 Rust | 📅 2026-09-08
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,371 | 🐛 584 | 🌐 D | 📅 2026-09-17
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,781 | 🐛 1 | 🌐 Rust | 📅 2026-09-16 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
* :octocat: [dynamic-analysis](https://github.com/analysis-tools-dev/dynamic-analysis) ⭐ 1,105 | 🐛 5 | 🌐 Markdown | 📅 2026-07-20 - A curated list of dynamic analysis tools and linters for all programming languages, binaries, and more
* :octocat: [awesome-llvm-security](https://github.com/gmh5225/awesome-llvm-security) ⭐ 879 | 🐛 0 | 📅 2026-08-14 - awesome llvm security projects
