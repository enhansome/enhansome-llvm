## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,765 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,603 | 🐛 39,391 | 🌐 LLVM | 📅 2026-09-22
* :octocat: [LLVM-Tutor](https://github.com/banach-space/llvm-tutor) ⭐ 3,436 | 🐛 14 | 🌐 C++ | 📅 2026-09-20 - A collection of out-of-tree LLVM passes for teaching and learning
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,603 | 🐛 39,391 | 🌐 LLVM | 📅 2026-09-22 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,918 | 🐛 587 | 🌐 C++ | 📅 2026-09-21 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  ...
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 625 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-09-21 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,626 | 🐛 2,490 | 🌐 C++ | 📅 2026-09-21 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,707 | 🐛 207 | 🌐 OCaml | 📅 2026-09-18 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,965 | 🐛 129 | 🌐 C | 📅 2026-09-08 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,239 | 🐛 1,163 | 🌐 C++ | 📅 2026-09-22 - Circuit IR Compilers and Tools
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,833 | 🐛 74 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,819 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 - A Dynamic Binary Instrumentation framework based on LLVM
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,708 | 🐛 211 | 🌐 C++ | 📅 2026-09-21 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,056 | 🐛 38 | 🌐 C++ | 📅 2026-09-08 - A LLVM-based static analysis framework
...
* [whole-program-llvm](https://github.com/travitch/whole-program-llvm) ⭐ 732 | 🐛 7 | 🌐 Python | 📅 2025-12-30 - A wrapper script to build whole-program LLVM bitcode files; its go port [gllvm](https://github.com/SRI-CSL/gllvm) ⭐ 342 | 🐛 13 | 🌐 Go | 📅 2024-04-28
...
* [seahorn/clam](https://github.com/seahorn/clam) ⭐ 289 | 🐛 5 | 🌐 C | 📅 2026-09-12 - a static analyzer (CLI) based on [seahorn/crab](https://github.com/seahorn/crab) ⭐ 255 | 🐛 5 | 🌐 C++ | 📅 2026-09-21, the latter of which is abstract Interpretation-based library
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,297 | 🐛 168 | 🌐 Python | 📅 2026-09-21 - A lightweight LLVM **python** binding for writing JIT compilers
* [go-llvm](https://github.com/tinygo-org/go-llvm) ⭐ 291 | 🐛 7 | 🌐 Go | 📅 2026-07-21 - **Go** binding
* [LLVM Rust crates](https://crates.io/search?q=llvm) - **Rust** bindings

# LLVM-backed Languages

* [codon](https://github.com/exaloop/codon) ⭐ 16,838 | 🐛 119 | 🌐 Python | 📅 2026-09-21
* [numba](https://github.com/numba/numba) ⭐ 11,158 | 🐛 1,798 | 🌐 Python | 📅 2026-09-21
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,693 | 🐛 400 | 🌐 Scala | 📅 2026-09-15
* [solang](https://github.com/hyperledger/solang) ⭐ 1,383 | 🐛 294 | 🌐 Rust | 📅 2026-09-08
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,370 | 🐛 584 | 🌐 D | 📅 2026-09-22
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,797 | 🐛 0 | 🌐 Rust | 📅 2026-09-21 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
* :octocat: [dynamic-analysis](https://github.com/analysis-tools-dev/dynamic-analysis) ⭐ 1,105 | 🐛 2 | 🌐 Rust | 📅 2026-09-21 - A curated list of dynamic analysis tools and linters for all programming languages, binaries, and more
