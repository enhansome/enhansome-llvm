## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,193 | 🐛 100 | 📅 2026-06-30
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 39,814 | 🐛 38,208 | 🌐 LLVM | 📅 2026-08-16
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 39,814 | 🐛 38,208 | 🌐 LLVM | 📅 2026-08-16 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  ...
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,345 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,675 | 🐛 298 | 🌐 OCaml | 📅 2026-08-12 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,608 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
* [ollvm](https://github.com/obfuscator-llvm/obfuscator/wiki) ⭐ 4,382 | 🐛 97 | 📅 2023-10-20 - code obfuscation based on LLVM4.0
* [cling](https://github.com/root-project/cling) ⭐ 4,175 | 🐛 136 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,808 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,922 | 🐛 129 | 🌐 C | 📅 2026-08-12 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,220 | 🐛 1,141 | 🌐 C++ | 📅 2026-08-15 - Circuit IR Compilers and Tools
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,808 | 🐛 19 | 🌐 C++ | 📅 2026-07-24 - A Dynamic Binary Instrumentation framework based on LLVM
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,796 | 🐛 73 | 🌐 C++ | 📅 2026-07-01 - Library for lifting machine code to LLVM bitcode
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,700 | 🐛 208 | 🌐 C++ | 📅 2026-07-30 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,053 | 🐛 37 | 🌐 C++ | 📅 2026-08-15 - A LLVM-based static analysis framework
...
* [seahorn/clam](https://github.com/seahorn/clam) ⭐ 286 | 🐛 4 | 🌐 C | 📅 2026-08-08 - a static analyzer (CLI) based on [seahorn/crab](https://github.com/seahorn/crab) ⭐ 253 | 🐛 3 | 🌐 C++ | 📅 2026-08-07, the latter of which is abstract Interpretation-based library
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,831 | 🐛 118 | 🌐 Python | 📅 2026-08-12
* [numba](https://github.com/numba/numba) ⭐ 11,122 | 🐛 1,804 | 🌐 Python | 📅 2026-08-15
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,684 | 🐛 418 | 🌐 Scala | 📅 2026-07-27
* [solang](https://github.com/hyperledger/solang) ⭐ 1,383 | 🐛 279 | 🌐 Rust | 📅 2026-08-15
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,362 | 🐛 580 | 🌐 D | 📅 2026-08-16
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,737 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
