## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,142 | 🐛 105 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,046 | 🐛 38,699 | 🌐 LLVM | 📅 2026-09-02
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,046 | 🐛 38,699 | 🌐 LLVM | 📅 2026-09-02 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,900 | 🐛 580 | 🌐 C++ | 📅 2026-08-28 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  ...
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 626 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-09-01 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,593 | 🐛 2,480 | 🌐 C++ | 📅 2026-09-02 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,700 | 🐛 205 | 🌐 OCaml | 📅 2026-09-01 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,941 | 🐛 129 | 🌐 C | 📅 2026-08-27 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,230 | 🐛 1,127 | 🌐 C++ | 📅 2026-09-02 - Circuit IR Compilers and Tools
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,817 | 🐛 20 | 🌐 C++ | 📅 2026-08-21 - A Dynamic Binary Instrumentation framework based on LLVM
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,816 | 🐛 73 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,707 | 🐛 208 | 🌐 C++ | 📅 2026-08-31 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,053 | 🐛 35 | 🌐 C++ | 📅 2026-08-27 - A LLVM-based static analysis framework
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,291 | 🐛 166 | 🌐 Python | 📅 2026-08-28 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [numba](https://github.com/numba/numba) ⭐ 11,142 | 🐛 1,797 | 🌐 Python | 📅 2026-08-31
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,687 | 🐛 423 | 🌐 Scala | 📅 2026-08-17
* [solang](https://github.com/hyperledger/solang) ⭐ 1,381 | 🐛 297 | 🌐 Rust | 📅 2026-09-01
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,368 | 🐛 578 | 🌐 D | 📅 2026-09-02
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,757 | 🐛 11 | 🌐 Rust | 📅 2026-08-30 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
