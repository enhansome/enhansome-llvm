## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,634 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,394 | 🐛 38,966 | 🌐 LLVM | 📅 2026-09-10
* :octocat: [LLVM-Tutor](https://github.com/banach-space/llvm-tutor) ⭐ 3,436 | 🐛 14 | 🌐 C++ | 📅 2026-05-17 - A collection of out-of-tree LLVM passes for teaching and learning
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,394 | 🐛 38,966 | 🌐 LLVM | 📅 2026-09-10 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,907 | 🐛 581 | 🌐 C++ | 📅 2026-09-09 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,354 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 624 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-09-09 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,604 | 🐛 2,480 | 🌐 C++ | 📅 2026-09-10 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 208 | 🌐 OCaml | 📅 2026-09-09 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
...
* [circt](https://github.com/llvm/circt) ⭐ 2,238 | 🐛 1,140 | 🌐 C++ | 📅 2026-09-09 - Circuit IR Compilers and Tools
...
* [seahorn/clam](https://github.com/seahorn/clam) ⭐ 287 | 🐛 5 | 🌐 C | 📅 2026-08-08 - a static analyzer (CLI) based on [seahorn/crab](https://github.com/seahorn/crab) ⭐ 252 | 🐛 4 | 🌐 C++ | 📅 2026-09-10, the latter of which is abstract Interpretation-based library
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,840 | 🐛 116 | 🌐 Python | 📅 2026-09-10
* [numba](https://github.com/numba/numba) ⭐ 11,150 | 🐛 1,789 | 🌐 Python | 📅 2026-09-09
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,689 | 🐛 394 | 🌐 Scala | 📅 2026-09-10
* [solang](https://github.com/hyperledger/solang) ⭐ 1,381 | 🐛 292 | 🌐 Rust | 📅 2026-09-08
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,371 | 🐛 581 | 🌐 D | 📅 2026-09-10
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,774 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
