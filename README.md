## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,971 | 🐛 106 | 📅 2026-08-21
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 39,935 | 🐛 38,412 | 🌐 LLVM | 📅 2026-08-26
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 39,935 | 🐛 38,412 | 🌐 LLVM | 📅 2026-08-26 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,891 | 🐛 578 | 🌐 C++ | 📅 2026-08-25 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  ...
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 625 | 🐛 90 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,574 | 🐛 2,475 | 🌐 C++ | 📅 2026-08-25 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,689 | 🐛 293 | 🌐 OCaml | 📅 2026-08-25 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,610 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
* [ollvm](https://github.com/obfuscator-llvm/obfuscator/wiki) ⭐ 4,388 | 🐛 97 | 📅 2023-10-20 - code obfuscation based on LLVM4.0
* [cling](https://github.com/root-project/cling) ⭐ 4,181 | 🐛 138 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,808 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,934 | 🐛 129 | 🌐 C | 📅 2026-08-23 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,226 | 🐛 1,127 | 🌐 C++ | 📅 2026-08-25 - Circuit IR Compilers and Tools
...
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,705 | 🐛 209 | 🌐 C++ | 📅 2026-08-24 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,054 | 🐛 35 | 🌐 C++ | 📅 2026-08-24 - A LLVM-based static analysis framework
...
* [smack](https://github.com/smackers/smack) ⭐ 448 | 🐛 94 | 🌐 C | 📅 2026-08-26 - SMACK Software Verifier and Verification Toolchain
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,284 | 🐛 169 | 🌐 Python | 📅 2026-08-25 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,836 | 🐛 119 | 🌐 Python | 📅 2026-08-25
* [numba](https://github.com/numba/numba) ⭐ 11,128 | 🐛 1,797 | 🌐 Python | 📅 2026-08-26
...
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,366 | 🐛 581 | 🌐 D | 📅 2026-08-26
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,750 | 🐛 28 | 🌐 Rust | 📅 2026-06-10 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
* :octocat: [dynamic-analysis](https://github.com/analysis-tools-dev/dynamic-analysis) ⭐ 1,102 | 🐛 5 | 🌐 Markdown | 📅 2026-07-20 - A curated list of dynamic analysis tools and linters for all programming languages, binaries, and more
