## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,410 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,133 | 🐛 38,858 | 🌐 LLVM | 📅 2026-09-06
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,133 | 🐛 38,858 | 🌐 LLVM | 📅 2026-09-06 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,904 | 🐛 580 | 🌐 C++ | 📅 2026-09-04 - first class support from the PyTorch ecosystem to the MLIR ecosystem
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,596 | 🐛 2,478 | 🌐 C++ | 📅 2026-09-05 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,701 | 🐛 204 | 🌐 OCaml | 📅 2026-09-03 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,622 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
...
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,946 | 🐛 129 | 🌐 C | 📅 2026-08-27 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,234 | 🐛 1,132 | 🌐 C++ | 📅 2026-09-06 - Circuit IR Compilers and Tools
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,838 | 🐛 125 | 🌐 Python | 📅 2026-09-06
* [numba](https://github.com/numba/numba) ⭐ 11,149 | 🐛 1,795 | 🌐 Python | 📅 2026-09-04
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,688 | 🐛 402 | 🌐 Scala | 📅 2026-09-05
* [solang](https://github.com/hyperledger/solang) ⭐ 1,382 | 🐛 293 | 🌐 Rust | 📅 2026-09-05
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,369 | 🐛 579 | 🌐 D | 📅 2026-09-06
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,766 | 🐛 12 | 🌐 Rust | 📅 2026-08-30 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
