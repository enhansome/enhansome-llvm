## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,546 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,440 | 🐛 39,105 | 🌐 LLVM | 📅 2026-09-13
* :octocat: [LLVM-Tutor](https://github.com/banach-space/llvm-tutor) ⭐ 3,438 | 🐛 14 | 🌐 C++ | 📅 2026-05-17 - A collection of out-of-tree LLVM passes for teaching and learning
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,440 | 🐛 39,105 | 🌐 LLVM | 📅 2026-09-13 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,910 | 🐛 577 | 🌐 C++ | 📅 2026-09-10 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,356 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
  * :octocat: [llvm/Polygeist](https://github.com/llvm/Polygeist) ⭐ 624 | 🐛 91 | 🌐 C++ | 📅 2025-06-19 - C/C++ frontend for MLIR
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-09-12 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,609 | 🐛 2,483 | 🌐 C++ | 📅 2026-09-12 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,706 | 🐛 207 | 🌐 OCaml | 📅 2026-09-10 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
...
* [cling](https://github.com/root-project/cling) ⭐ 4,190 | 🐛 138 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,809 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [klee](https://github.com/klee/klee) ⭐ 2,976 | 🐛 82 | 🌐 C++ | 📅 2026-08-21 - Symbolic Virtual Machine
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,954 | 🐛 129 | 🌐 C | 📅 2026-09-08 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,240 | 🐛 1,145 | 🌐 C++ | 📅 2026-09-12 - Circuit IR Compilers and Tools
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,825 | 🐛 73 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,819 | 🐛 20 | 🌐 C++ | 📅 2026-09-02 - A Dynamic Binary Instrumentation framework based on LLVM
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,708 | 🐛 209 | 🌐 C++ | 📅 2026-08-31 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,057 | 🐛 35 | 🌐 C++ | 📅 2026-09-08 - A LLVM-based static analysis framework
* [microsoft/llvm-mctoll](https://github.com/microsoft/llvm-mctoll) ⭐ 879 | 🐛 46 | 🌐 C++ | 📅 2024-06-22 - statically (AOT) translates (or raises) binaries to LLVM IR
...
* [seahorn/clam](https://github.com/seahorn/clam) ⭐ 287 | 🐛 5 | 🌐 C | 📅 2026-09-12 - a static analyzer (CLI) based on [seahorn/crab](https://github.com/seahorn/crab) ⭐ 252 | 🐛 4 | 🌐 C++ | 📅 2026-09-12, the latter of which is abstract Interpretation-based library
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,293 | 🐛 169 | 🌐 Python | 📅 2026-09-10 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,841 | 🐛 115 | 🌐 Python | 📅 2026-09-13
* [numba](https://github.com/numba/numba) ⭐ 11,151 | 🐛 1,789 | 🌐 Python | 📅 2026-09-11
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,691 | 🐛 393 | 🌐 Scala | 📅 2026-09-12
* [solang](https://github.com/hyperledger/solang) ⭐ 1,381 | 🐛 293 | 🌐 Rust | 📅 2026-09-08
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,371 | 🐛 583 | 🌐 D | 📅 2026-09-13
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,781 | 🐛 11 | 🌐 Rust | 📅 2026-09-11 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
* :octocat: [dynamic-analysis](https://github.com/analysis-tools-dev/dynamic-analysis) ⭐ 1,104 | 🐛 5 | 🌐 Markdown | 📅 2026-07-20 - A curated list of dynamic analysis tools and linters for all programming languages, binaries, and more
* :octocat: [awesome-llvm-security](https://github.com/gmh5225/awesome-llvm-security) ⭐ 881 | 🐛 0 | 📅 2026-08-14 - awesome llvm security projects
* :octocat: [LLVM-Guide](https://github.com/mikeroyal/LLVM-Guide) ⭐ 204 | 🐛 0 | 🌐 C++ | 📅 2024-01-04
