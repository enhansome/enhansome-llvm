## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,569 | 🐛 105 | 📅 2026-08-21
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,015 | 🐛 38,636 | 🌐 LLVM | 📅 2026-08-31
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,015 | 🐛 38,636 | 🌐 LLVM | 📅 2026-08-31 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,896 | 🐛 577 | 🌐 C++ | 📅 2026-08-28 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  * :octocat: [j2kun/mlir-tutorial](https://github.com/j2kun/mlir-tutorial) ⭐ 1,349 | 🐛 8 | 🌐 C++ | 📅 2025-07-18 - a series of articles on the MLIR framework for building compilers
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,586 | 🐛 2,479 | 🌐 C++ | 📅 2026-08-30 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,692 | 🐛 201 | 🌐 OCaml | 📅 2026-08-27 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,616 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
* [ollvm](https://github.com/obfuscator-llvm/obfuscator/wiki) ⭐ 4,392 | 🐛 97 | 📅 2023-10-20 - code obfuscation based on LLVM4.0
* [cling](https://github.com/root-project/cling) ⭐ 4,186 | 🐛 138 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,809 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [circt](https://github.com/llvm/circt) ⭐ 2,230 | 🐛 1,134 | 🌐 C++ | 📅 2026-08-29 - Circuit IR Compilers and Tools
* [QBDI](https://github.com/QBDI/QBDI) ⭐ 1,816 | 🐛 20 | 🌐 C++ | 📅 2026-08-21 - A Dynamic Binary Instrumentation framework based on LLVM
* [remill](https://github.com/lifting-bits/remill) ⭐ 1,815 | 🐛 73 | 🌐 C++ | 📅 2026-08-27 - Library for lifting machine code to LLVM bitcode
...
* [llvmlite](https://github.com/numba/llvmlite) ⭐ 2,292 | 🐛 167 | 🌐 Python | 📅 2026-08-28 - A lightweight LLVM **python** binding for writing JIT compilers
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,835 | 🐛 125 | 🌐 Python | 📅 2026-08-31
* [numba](https://github.com/numba/numba) ⭐ 11,137 | 🐛 1,799 | 🌐 Python | 📅 2026-08-28
* [scala-native](https://github.com/scala-native/scala-native) ⭐ 4,686 | 🐛 423 | 🌐 Scala | 📅 2026-08-17
* [solang](https://github.com/hyperledger/solang) ⭐ 1,381 | 🐛 301 | 🌐 Rust | 📅 2026-08-30
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,367 | 🐛 580 | 🌐 D | 📅 2026-08-31
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,755 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
