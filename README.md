## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,276 | 🐛 106 | 📅 2026-09-02
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 40,528 | 🐛 39,217 | 🌐 LLVM | 📅 2026-09-18
* :octocat: [LLVM-Tutor](https://github.com/banach-space/llvm-tutor) ⭐ 3,433 | 🐛 14 | 🌐 C++ | 📅 2026-05-17 - A collection of out-of-tree LLVM passes for teaching and learning
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 40,528 | 🐛 39,217 | 🌐 LLVM | 📅 2026-09-18 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,919 | 🐛 587 | 🌐 C++ | 📅 2026-09-17 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  ...
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 84 | 🌐 MLIR | 📅 2026-09-17 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,613 | 🐛 2,478 | 🌐 C++ | 📅 2026-09-18 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,704 | 🐛 208 | 🌐 OCaml | 📅 2026-09-16 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,629 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
* [ollvm](https://github.com/obfuscator-llvm/obfuscator/wiki) ⭐ 4,395 | 🐛 97 | 📅 2023-10-20 - code obfuscation based on LLVM4.0
* [cling](https://github.com/root-project/cling) ⭐ 4,195 | 🐛 138 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,809 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [klee](https://github.com/klee/klee) ⭐ 2,979 | 🐛 82 | 🌐 C++ | 📅 2026-08-21 - Symbolic Virtual Machine
* [mstorsjo/llvm-mingw](https://github.com/mstorsjo/llvm-mingw) ⭐ 2,959 | 🐛 129 | 🌐 C | 📅 2026-09-08 - An LLVM/Clang/LLD based mingw-w64 toolchain
...
* [circt](https://github.com/llvm/circt) ⭐ 2,240 | 🐛 1,155 | 🌐 C++ | 📅 2026-09-17 - Circuit IR Compilers and Tools
...
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,708 | 🐛 212 | 🌐 C++ | 📅 2026-09-17 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
* [Phasar](https://github.com/secure-software-engineering/phasar) ⭐ 1,056 | 🐛 36 | 🌐 C++ | 📅 2026-09-08 - A LLVM-based static analysis framework
...
* [go-llvm](https://github.com/tinygo-org/go-llvm) ⭐ 291 | 🐛 6 | 🌐 Go | 📅 2026-07-21 - **Go** binding
* [LLVM Rust crates](https://crates.io/search?q=llvm) - **Rust** bindings

# LLVM-backed Languages

* [codon](https://github.com/exaloop/codon) ⭐ 16,837 | 🐛 117 | 🌐 Python | 📅 2026-09-18
* [numba](https://github.com/numba/numba) ⭐ 11,156 | 🐛 1,790 | 🌐 Python | 📅 2026-09-17
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,784 | 🐛 1 | 🌐 Rust | 📅 2026-09-17 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
...
* :octocat: [awesome-llvm-security](https://github.com/gmh5225/awesome-llvm-security) ⭐ 880 | 🐛 0 | 📅 2026-08-14 - awesome llvm security projects
