## Awesome LLVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,688 | 🐛 105 | 📅 2026-08-21
...
* 🐉 [Tools for Learning LLVM TableGen](https://blog.llvm.org/posts/2023-12-07-tools-for-learning-llvm-tablegen/) - tutorial by David Spickett about LLVM's [TableGen](https://github.com/llvm/llvm-project/tree/main/llvm/utils/TableGen) ⭐ 39,846 | 🐛 38,383 | 🌐 LLVM | 📅 2026-08-22
...
* [BOLT](https://github.com/llvm/llvm-project/blob/main/bolt/README.md) ⭐ 39,846 | 🐛 38,383 | 🌐 LLVM | 📅 2026-08-22 - a post-link optimizer developed to speed up large applications
* Core Utilities
...
* [MLIR](https://mlir.llvm.org/) - Multi-Level Intermediate Representation
  * :octocat: [llvm/Torch-LLVM](https://github.com/llvm/torch-mlir) ⭐ 1,888 | 🐛 583 | 🌐 C++ | 📅 2026-08-20 - first class support from the PyTorch ecosystem to the MLIR ecosystem
  ...
  * :octocat: [intel/mlir-extensions](https://github.com/intel/mlir-extensions/tree/main) ⭐ 156 | 🐛 83 | 🌐 MLIR | 📅 2026-08-19 - Intel® Extension for MLIR
...
* [Emscripten](https://github.com/kripken/emscripten) ⭐ 27,576 | 🐛 2,472 | 🌐 C++ | 📅 2026-08-22 - An LLVM-to-JavaScript Compiler
* [Infer](https://github.com/facebook/infer) ⭐ 15,685 | 🐛 296 | 🌐 OCaml | 📅 2026-08-21 - Facebook's static analysis framework; C/C++/objc is based on LLVM/Clang
* [RetDec](https://github.com/avast/retdec) ⭐ 8,607 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - a retargetable machine-code decompiler based on LLVM
* [ollvm](https://github.com/obfuscator-llvm/obfuscator/wiki) ⭐ 4,386 | 🐛 97 | 📅 2023-10-20 - code obfuscation based on LLVM4.0
* [cling](https://github.com/root-project/cling) ⭐ 4,179 | 🐛 137 | 🌐 C++ | 📅 2026-08-06 - The cling C++ interpreter ([1.0](https://github.com/vgvassilev/cling/releases/tag/v1.0) ⭐ 1,808 | 🐛 67 | 🌐 C++ | 📅 2026-07-30 has been released)
...
* [circt](https://github.com/llvm/circt) ⭐ 2,226 | 🐛 1,129 | 🌐 C++ | 📅 2026-08-21 - Circuit IR Compilers and Tools
...
* [SVF-tools](https://github.com/SVF-tools/SVF) ⭐ 1,702 | 🐛 208 | 🌐 C++ | 📅 2026-07-30 - Pointer Analysis and Program Dependence Analysis for C and C++ Programs
...
* [smack](https://github.com/smackers/smack) ⭐ 448 | 🐛 93 | 🌐 C | 📅 2026-08-20 - SMACK Software Verifier and Verification Toolchain
...
* [codon](https://github.com/exaloop/codon) ⭐ 16,830 | 🐛 119 | 🌐 Python | 📅 2026-08-21
...
* [solang](https://github.com/hyperledger/solang) ⭐ 1,382 | 🐛 300 | 🌐 Rust | 📅 2026-08-15
* [ldc](https://github.com/ldc-developers/ldc) ⭐ 1,364 | 🐛 580 | 🌐 D | 📅 2026-08-22
...
* :octocat: [static-analysis](https://github.com/analysis-tools-dev/static-analysis) ⭐ 14,744 | 🐛 27 | 🌐 Rust | 📅 2026-06-10 - A curated list of static analysis tools and linters for all programming languages, config files, build tools, and more
